...
PRIOR_DEVIATIONS = [30]  # Single configuration: 30% priors
SLD_MODES = ["none"]  # No SLD fixing
PROMINENT_FEATURES = [False]  # No prominent features
PRIORS_TYPE = "constraint_based"  # Use the new constraint-based priors

# Inference backend configuration
INFERENCE_BACKEND = "nf"  # "predict" or "nf"
NF_CONFIG_NAME = (
    "example_nf_config_reflectorch.yaml"  # used when INFERENCE_BACKEND == "nf"
)
NF_NUM_SAMPLES = 1000
...
SWEEP_RESULTS_DIR = "sweep_results_nf_baseline"
